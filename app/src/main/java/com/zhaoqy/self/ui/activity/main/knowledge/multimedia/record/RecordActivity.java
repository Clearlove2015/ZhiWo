package com.zhaoqy.self.ui.activity.main.knowledge.multimedia.record;
...
import static com.zhaoqy.self.util.DpUtil.SIZE_1;
import static com.zhaoqy.self.util.DpUtil.SIZE_2;
...
public class RecordActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    private void doStartSize() {
        int screenWidth = DpUtil.getScreenWidth(this);
        int screenHeight = DpUtil.getScreenHeight(this);
        DpUtil.setViewSize(cameraShowView, screenWidth * SIZE_1 / SIZE_2, screenHeight);
    }
